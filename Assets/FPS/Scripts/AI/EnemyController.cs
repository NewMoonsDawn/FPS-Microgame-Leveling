...
namespace Unity.FPS.AI
{
    ...
    public class EnemyController : MonoBehaviour
    {
        ...
        public List<float> DropRate = new List<float>();
        ...
        public bool TryDropItem(int i)
        {
            if (DropRate[i] == 0 || LootPrefab == null)
                return false;
            else if (DropRate[i] == 1)
                return true;
            else
                return (Random.value <= DropRate[i]);
        }
